<td>
    <div class='btn-list'>
        <a href="{{ route('inasistencias.edit', $id) }}" class='btn btn-info' data-bs-toggle="tooltip"
           data-bs-placement="top" title="Editar">
            <span>Editar</span>
        </a>

        <form action="{{ route('inasistencias.destroy', $id) }}" method="POST" class="btn-delete" style="display:inline;">
            @csrf
            @method('DELETE')
